                ...
                <div className="flex gap-4">
                  {socialLinks.map((social) => (
                    <motion.a
                      ...
                      className="w-14 h-14 rounded-xl bg-brand-warm-white border border-brand-gold/10 flex items-center justify-center hover:border-brand-saffron/30 hover:bg-brand-saffron/5 transition-all duration-300"
